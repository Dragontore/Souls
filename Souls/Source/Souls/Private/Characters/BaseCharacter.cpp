...
void ABaseCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	//PlayerInputComponent->BindAxis("TurnRate", this, &AMainPlayerController::TurnAtRate);
	PlayerInputComponent->BindAxis("LookUp", this, &APawn::AddControllerPitchInput);
	//PlayerInputComponent->BindAxis("LookUpRate", this, &AMainPlayerController::LookUpAtRate);
